...
- [IoB + 딥러닝(CNN)] 카페 내 현황(**좌석 점유율**, **고객 외형**, **고객 행동**, **주문 메뉴**)을 실시간 추론   
- IoT 장치(Raspberry Pi 4B)에 탑재를 위한 CNN모델 경량화 + 정확도 및 속도 유지   
- 실시간 영상 분석을 통한 카페 내 현황 실시간 데이터 마이닝(**4종의 CNN 모델**)   
